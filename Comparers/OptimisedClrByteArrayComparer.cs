...
{
    public class OptimisedClrByteArrayComparer : IComparer<byte[]>, IEqualityComparer<byte[]>
    {
        public static readonly OptimisedClrByteArrayComparer Value = new OptimisedClrByteArrayComparer();
